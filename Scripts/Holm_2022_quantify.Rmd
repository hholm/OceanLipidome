...
#picograms injected EXPORTS and WAP different (Dmix)
Joined_metadata[which(Joined_metadata$cruise == "EXPORTS"),"recovery"] <- t(Joined_lipid[which(Joined$species == "DNPPE"),which(Joined_metadata$cruise == "EXPORTS")]/375000)
Joined_metadata[which(Joined_metadata$cruise == "WAP"),"recovery"] <- t(Joined_lipid[which(Joined$species == "DNPPE"),which(Joined_metadata$cruise == "WAP")]/500000)
